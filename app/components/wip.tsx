...
export default function UnderConstruction() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center w-full px-4 bg-[#B5AD21]">
      ...
      <p className="text-lg sm:text-3xl mb-6 text-[#45140C] font-medium font-inter text-center">
        This page is currently still being developed. Please check back soon!
      </p>
      <div className="flex flex-col items-center">
        ...
        <Image src="/littleguys.svg" alt="Construction illustration" width={300} height={300} className="w-40 sm:w-75 h-auto" /> 
      </div>
    </div>
  );
}
